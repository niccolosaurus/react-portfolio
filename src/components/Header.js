...
function Header({buttonText, title}) {
  return (
//     <nav class="hero">
//     <ul id="nav-list">
...
<section class="hero">
          ...
          <div class="hero-area">
            ...
            <div class="socials">
                <div><a href="https://twitter.com/niccolosaurus" class="social">
                ...
                <div><a href="https://github.com/niccolosaurus"  class="social">
                ...
                <div><a href="https://www.linkedin.com/in/niccolo-eck-195714223/"  class="social">
